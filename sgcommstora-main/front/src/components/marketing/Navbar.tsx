  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50">
      <div className="mx-auto max-w-[1440px] px-4 sm:px-7">
        <div className="relative mt-3 flex h-14 items-center justify-between rounded-full border border-black/[0.07] bg-[#e9e9e9]/90 px-2.5 pl-4 shadow-[0_12px_35px_-24px_rgba(0,0,0,.35)] backdrop-blur-2xl sm:mt-4 sm:pl-5">
          <Logo />
        ...
        {open && (
          <nav id="mobile-navigation" aria-label="Navigation mobile" className="animate-fade-in mt-2 flex flex-col rounded-[24px] border border-line bg-[#ededed]/95 p-2 shadow-xl backdrop-blur-xl lg:hidden">
